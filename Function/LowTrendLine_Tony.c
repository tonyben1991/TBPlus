...
Begin
    ...
    if(GetNumericArraySize(arr_lines) > 0 && GetNumericArraySize(arr_points) > 0)
    {
        ...
        arr_trend_lines[2] = (Min(Open[CurrentBar - arr_trend_lines[0]], Close[CurrentBar - arr_trend_lines[0]]) - Min(Open[CurrentBar - arr_trend_lines[1]], Close[CurrentBar - arr_trend_lines[1]])) / (arr_trend_lines[0] - arr_trend_lines[1]);
        arr_trend_lines[3] = Min(Open[CurrentBar - arr_trend_lines[0]], Close[CurrentBar - arr_trend_lines[0]]) - arr_trend_lines[0] * arr_trend_lines[2];
    }
